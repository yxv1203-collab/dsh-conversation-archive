  ...
  factory: (require) => {
    ...
    function WorkspaceSettings() {
      ...
      return h('div', { className: 'dwm' },
        ...
        state.status?.pendingDeletionCount ? h('div', { className: 'dwm-alert' }, `${state.status.pendingDeletionCount} 项数据已移入回收站；重启 DSH 后将移除工作区引用并完成删除。`) : null,
